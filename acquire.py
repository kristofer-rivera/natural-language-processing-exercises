...
def get_blog_articles(use_cache=True):
    ...
    """
    This function uses the get_blog_urls then takes in a list of urls for Codeup blog articles. It loops through each, and uses the parse_blog() function to get the
    title, publishing date, category, and article content and create a dictionaries that are placed into a list. It returns a list of dictionaries.
    """
